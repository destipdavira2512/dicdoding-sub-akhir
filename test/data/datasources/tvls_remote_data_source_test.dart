...
void main() {
  ...
  late TvlsRemoteDataSourceImpl dataSourcetv;
  late MockHttpClient mockHttpClient;

  setUp(() {
    mockHttpClient = MockHttpClient();
    dataSourcetv = TvlsRemoteDataSourceImpl(client: mockHttpClient);
  });

  group('get Now Playing Tv', () {
    final tTvList = TvlsResponse.fromJson(
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      // act
      final result = await dataSourcetv.getserialTvSaatIniDiPutar();
      // assert
    ...
    test(
      ...
      // act
      final call = dataSourcetv.getserialTvSaatIniDiPutar();
      // assert
  ...
  group('get Popular Tv', () {
    final tTvList = TvlsResponse.fromJson(
            json.decode(readJson('dummy_data/popular_tvls.json')))
        .tvList;
    ...
    test('should return list of tv when response is success (200)', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/popular?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/popular_tvls.json'), 200));
      // act
  ...
  group('get Top Rated Tv', () {
    final tTvList = TvlsResponse.fromJson(
            json.decode(readJson('dummy_data/top_rated_tvls.json')))
        .tvList;
    ...
    test('should return list of tv when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/top_rated_tvls.json'), 200));
      // act
  ...
  group('get tv detail', () {
    final tId = 1;
    final tTvDetail = TvlsDetailResponse.fromJson(
        json.decode(readJson('dummy_data/tvls_detail.json')));

    test('should return film detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/$tId?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/tvls_detail.json'), 200));
      // act
  ...
  group('get tv recommendations', () {
    final tTvList = TvlsResponse.fromJson(
            json.decode(readJson('dummy_data/tvls_recommendations.json')))
        .tvList;
    final tId = 1;
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/tvls_recommendations.json'), 200));
      // act
  ...
  group('search tv', () {
    final tSearchResult = TvlsResponse.fromJson(
            json.decode(readJson('dummy_data/search_got_tvls.json')))
        .tvList;
    ...
    test('should return list of tv when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/search_got_tvls.json'), 200));
      // act
